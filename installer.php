...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20201210_kodeksgeneric_4aa0c366d18886715758_20201210115311_archive.zip';
    const ARCHIVE_SIZE       = '39250709';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '4aa0c36-10115311';
    const SECONDARY_PACKAGE_HASH = '09bcd82-10115311';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.1.1==');
        $this->log('----------------------------------------------------');
